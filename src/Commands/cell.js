...
module.exports = {
    ...
    run: async(client, message, args) => {
        if(args[0].toLowerCase() === "string") {return message.channel.send("seed.")}
        else if(args[0].toLowerCase() === "maze") {return message.channel.send("builds cool stuff.")}
        else if(args[0].toLowerCase() === "square") {return message.channel.send("it's actually rectangle")}
        else if(args[0].toLowerCase()=== "life") {return message.channel.send("the original")}
        else {
